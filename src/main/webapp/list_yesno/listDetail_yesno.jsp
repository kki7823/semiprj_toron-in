...
<head>
    ...
    <link href="../css/style1.css?ktSijk" rel="stylesheet" type="text/css">
...
<body style="background-color: #e9f2e9">
    ...
    <div id="listD_container" class="container-xxl">
        <div id="listD_mainrow" class="row">
            ...
            <!--Start of mainbox-->
            <div id="listD_mainbox_y" class="col" style="width:800px;">
            ...
            <div id="listD_yesno_nav" class=col; style="width:150px;border: 3px solid #8e9c90; border-radius:20px; margin-left:20px;">
