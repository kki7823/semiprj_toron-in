...
<head>
    ...
    <link href="../css/style.css?ver=22Z" rel="stylesheet" type="text/css">
...
<%--                        </c:choose>--%>
                ...
                <div id="listD_buttonbox">
                    <hr class="my-4"/>
                    <button class="btn btn-primary btn-sm" onclick="location.href='../List?cat=3'" style="margin-right: 20px;">목록으로
                    </button>
                </div>
            </div> <!--End of mainbox-->
